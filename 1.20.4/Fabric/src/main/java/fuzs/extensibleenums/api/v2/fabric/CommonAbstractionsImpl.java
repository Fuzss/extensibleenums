...
public class CommonAbstractionsImpl {
    ...
    public static EnchantmentCategory createEnchantmentCategory(ResourceLocation identifier, Predicate<Item> canApplyTo) {
        ...
        new EnumAppender<>(EnchantmentCategory.class, EnchantmentCategory.VANISHABLE.getClass()).addEnumConstant(internalName).applyTo();
        EnchantmentCategory enumConstant = BuiltInEnumFactories.testEnumValueAddition(EnchantmentCategory.class, internalName);
